...
import "./BlockchainEstateToken.sol";

contract BlockchainEstateTokenPreSale {
    BlockchainEstateToken public token;
    ...
    function BlockchainEstateTokenPreSale(
        BlockchainEstateToken _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = BlockchainEstateToken(_token);
